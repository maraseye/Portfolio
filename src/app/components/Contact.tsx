          ...
          >
            <div>
              ...
              <p className="text-slate-400 mb-8">
                Je suis disponible pour des opportunites, des collaborations et des echanges techniques.
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8">
                ...
                <p className="text-slate-400 mb-6">
                  Clique sur le bouton ci-dessous pour ouvrir ton client mail avec mon adresse pre-remplie.
                </p>
                <motion.a
                ...
                >
                  ...
                  Ecrire a maraseye2004@gmail.com
                </motion.a>
              </div>
            </div>
          </motion.div>
